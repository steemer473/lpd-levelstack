...
export const SAMPLE_REPORT: LevelstackReportJson = {
  ...
  recommendations: [
    {
      id: "rec_sample_01_respond_reviews",
      title: "Respond to both negative Google reviews",
      summary:
        "Acknowledge the concern, offer direct contact. Removes the unanswered signal that amplifies doubt for new prospects.",
      evidence: [],
      confidence: {
        band: "High",
        rationale: "Sample fixture",
      ...
      artifact: { kind: "reply_draft", content: "Thank you for the feedback — please contact us directly so we can make this right." },
      urgency: "Unanswered negatives are live in search results now.",
      consequenceOfInaction: "Prospects keep seeing silence next to low star ratings.",
      sourceSectionId: "search_footprint",
      effortHint: "30 min",
    },
    {
      id: "rec_sample_02_pause_ads",
      title: "Pause Facebook/Instagram ad spend until the landing page is updated",
      summary:
        "You are spending $1,200/month sending warm traffic to a page that cannot convert.",
      evidence: [],
      confidence: {
        band: "High",
        rationale: "Sample fixture",
      ...
      urgency: "Budget is burning on an unready destination this week.",
      consequenceOfInaction: "Paid clicks keep abandoning before booking.",
      sourceSectionId: "search_footprint",
      effortHint: "15 min",
    },
    {
      id: "rec_sample_03_claim_yelp",
      title: "Claim and complete your Yelp profile",
      summary:
        "Add correct phone, services, hours, and 2–3 photos.",
      evidence: [],
      confidence: {
        band: "Medium",
        rationale: "Sample fixture",
      ...
      priority: "P0",
      roi: { kind: "upside", rangeLabel: "Moderate" },
      dependencies: { recommendationIds: [] },
      owner: { role: "business_owner" },
      automatability: { automatable: false },
      artifact: { kind: "checklist" },
      urgency: "Auto-generated listings still speak for you.",
      consequenceOfInaction: "Prospects find incomplete third-party pages first.",
      sourceSectionId: "search_footprint",
      effortHint: "45 min",
    },
    {
      id: "rec_sample_04_instagram",
      title: "Post one piece of content to Instagram today",
      summary: "Break the 91-day gap with a single real post.",
      evidence: [],
      confidence: {
        band: "Medium",
        rationale: "Sample fixture",
      ...
      automatability: { automatable: false },
      artifact: { kind: "none" },
      urgency: "Ninety-one days of silence reads as inactive.",
      consequenceOfInaction: "Competitors look more current in social proof checks.",
      sourceSectionId: "search_footprint",
      effortHint: "20 min",
    },
  ],
